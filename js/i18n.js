...
export const I18N={
  vi:{
    ...
    'auth.forgot':'Quên mật khẩu?','auth.resetSent':'📧 Đã gửi email đặt lại mật khẩu. Kiểm tra hộp thư (cả mục Spam).','auth.enterEmailFirst':'⚠️ Nhập email trước đã',
    ...
    'tab.dash':'Tổng quan','tab.wallets':'Ví','tab.recurring':'Định kỳ','tab.budget':'Ngân sách','tab.charts':'Biểu đồ','tab.calendar':'Lịch','nav.collapse':'Thu gọn',
    ...
    'report.monthly':'Thu & chi theo tháng','report.avgDay':'Chi TB/ngày (tháng này)','report.projected':'Dự báo chi cuối tháng','report.saveRate':'Tỉ lệ tiết kiệm tháng này','report.topMonth':'Tháng chi nhiều nhất',
    ...
    'budget.total':'Tổng hạn mức (₫)','budget.totalPh':'VD: 10,000,000','budget.save':'💾 Lưu hạn mức',
    'budget.monthly':'Theo tháng','budget.weekly':'Theo tuần','dash.budgetWeek':'🎯 Ngân sách tuần này',
    ...
    'tt.delete':'Xoá','tt.edit':'Sửa','tt.editWallet':'Sửa ví','tt.deleteWallet':'Xoá ví','tt.toggle':'Bật/tắt','tt.viewPhoto':'Xem ảnh',
    'photo.label':'Ảnh hóa đơn (tuỳ chọn)','photo.choose':'📷 Chọn ảnh',
    ...
    'bills.pay':'✓ Thanh toán','bills.markPaid':'Đã trả','bills.markPaidTip':'Đánh dấu đã trả tháng này (không trừ tiền) — tháng sau tự nhắc lại','bills.paid':'✅ Đã trả tháng này','bills.dueIn':'Còn {n} ngày','bills.dueToday':'⏰ Đến hạn hôm nay','bills.overdue':'🔴 Quá hạn {n} ngày','bills.banner':'🔔 Hóa đơn sắp đến hạn',
    'bills.enterName':'⚠️ Nhập tên hóa đơn',
    'toast.billCreated':'🔔 Đã thêm hóa đơn','toast.billUpdated':'💾 Đã cập nhật hóa đơn','toast.billDeleted':'🗑️ Đã xoá hóa đơn','toast.billPaid':'✅ Đã thanh toán {name}','toast.billMarked':'✅ Đã đánh dấu đã trả: {name} (không trừ tiền)',
    'confirm.deleteBillTitle':'🗑️ Xoá hóa đơn','confirm.deleteBillMsg':'Xoá hóa đơn "{name}"?',
    'bills.notify':'🔔 Bật nhắc trên thiết bị','bills.notifyOn':'✅ Đã bật nhắc trên thiết bị','bills.notifyBlocked':'🔕 Thông báo bị chặn (mở cài đặt trình duyệt)','bills.notifyUnsupported':'Thiết bị không hỗ trợ thông báo','bills.notifyTitle':'🔔 Hóa đơn đến hạn',
    'tab.settings':'Cài đặt',
    'settings.backupTitle':'Sao lưu & khôi phục','settings.backupHint':'Tải toàn bộ dữ liệu về một file (.json) để lưu trữ; khôi phục lại khi cần.',
    'settings.backup':'⬇ Tải bản sao lưu','settings.restore':'⬆ Khôi phục từ file','settings.backupDone':'💾 Đã tải bản sao lưu',
    'settings.restoreTitle':'Khôi phục dữ liệu','settings.restoreConfirm':'Khôi phục từ bản sao lưu ({n} giao dịch)? Dữ liệu sẽ được ghi đè/thêm vào (không xoá dữ liệu hiện có).','settings.restoreOk':'Khôi phục','settings.restoreDone':'✅ Đã khôi phục dữ liệu','settings.fileError':'⚠️ File không hợp lệ',
    'settings.importTitle':'Nhập giao dịch từ CSV','settings.importHint':'Nhập các dòng Thu/Chi từ file CSV (đúng định dạng khi Xuất CSV). Dòng chuyển ví sẽ được bỏ qua.','settings.importCsv':'⬆ Chọn file CSV…',
    'settings.csvTitle':'Nhập CSV','settings.csvConfirm':'Nhập giao dịch từ file CSV này?','settings.csvOk':'Nhập','settings.csvDone':'📥 Đã nhập {n} giao dịch','settings.csvEmpty':'⚠️ File CSV trống hoặc sai định dạng',
  ...
  en:{
    ...
    'auth.forgot':'Forgot password?','auth.resetSent':'📧 Password reset email sent. Check your inbox (and Spam).','auth.enterEmailFirst':'⚠️ Enter your email first',
    ...
    'tab.dash':'Overview','tab.wallets':'Wallets','tab.recurring':'Recurring','tab.budget':'Budget','tab.charts':'Charts','tab.calendar':'Calendar','nav.collapse':'Collapse',
    'cal.noTx':'No transactions this day.',
    ...
    'report.monthly':'Income & expense by month','report.avgDay':'Avg spend/day (this month)','report.projected':'Projected month-end spend','report.saveRate':'This month savings rate','report.topMonth':'Highest spending month',
    ...
    'budget.total':'Total limit (₫)','budget.totalPh':'e.g. 10,000,000','budget.save':'💾 Save limit',
    'budget.monthly':'Monthly','budget.weekly':'Weekly','dash.budgetWeek':"🎯 This week's budget",
    ...
    'tt.delete':'Delete','tt.edit':'Edit','tt.editWallet':'Edit wallet','tt.deleteWallet':'Delete wallet','tt.toggle':'Toggle','tt.viewPhoto':'View photo',
    'photo.label':'Receipt photo (optional)','photo.choose':'📷 Choose photo',
    ...
    'bills.pay':'✓ Pay','bills.markPaid':'Mark paid','bills.markPaidTip':'Mark paid for this month (no deduction) — reminds again next month','bills.paid':'✅ Paid this month','bills.dueIn':'{n} days left','bills.dueToday':'⏰ Due today','bills.overdue':'🔴 Overdue {n} days','bills.banner':'🔔 Upcoming bills',
    'bills.enterName':'⚠️ Enter a bill name',
    'toast.billCreated':'🔔 Bill added','toast.billUpdated':'💾 Bill updated','toast.billDeleted':'🗑️ Bill deleted','toast.billPaid':'✅ Paid {name}','toast.billMarked':'✅ Marked as paid: {name} (no deduction)',
    'confirm.deleteBillTitle':'🗑️ Delete bill','confirm.deleteBillMsg':'Delete bill "{name}"?',
    'bills.notify':'🔔 Enable device alerts','bills.notifyOn':'✅ Device alerts enabled','bills.notifyBlocked':'🔕 Notifications blocked (open browser settings)','bills.notifyUnsupported':'Notifications not supported','bills.notifyTitle':'🔔 Bill due',
    'tab.settings':'Settings',
    'settings.backupTitle':'Backup & restore','settings.backupHint':'Download all your data as a (.json) file; restore it whenever needed.',
    'settings.backup':'⬇ Download backup','settings.restore':'⬆ Restore from file','settings.backupDone':'💾 Backup downloaded',
    'settings.restoreTitle':'Restore data','settings.restoreConfirm':'Restore from backup ({n} transactions)? Data will be merged/overwritten (existing data is not deleted).','settings.restoreOk':'Restore','settings.restoreDone':'✅ Data restored','settings.fileError':'⚠️ Invalid file',
    'settings.importTitle':'Import transactions from CSV','settings.importHint':'Import income/expense rows from a CSV (same format as Export CSV). Transfer rows are skipped.','settings.importCsv':'⬆ Choose CSV file…',
    'settings.csvTitle':'Import CSV','settings.csvConfirm':'Import transactions from this CSV file?','settings.csvOk':'Import','settings.csvDone':'📥 Imported {n} transactions','settings.csvEmpty':'⚠️ Empty or invalid CSV',
